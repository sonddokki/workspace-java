...
//			num = num + 10;  // 외부 클래스의 인스턴스 변수는 사용불가
			...
			System.out.println("InStaticClass sInNum = " +sInNum+ "(정적 내부클래스의 인스턴스 변수 사용)" );
			System.out.println("OutClass sNum = " +sNum+ "(정적 내부클래스의 인스턴스 변수 사용)" );	
		}
...
public class InnerClassTest {
	public static void main(String[] args) {
		...
		// (이미 만들어진) 외부클래스 객체를 이용하여 내부 클래스의 메서드 호출
