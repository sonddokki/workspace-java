package kr.co.himedia.thread04.solve02;
...
class Lee extends Thread {
	...
	public void run() {
		...
		System.out.println("3000원 입금 : " + SyncronizationTest.myBank.getMoney());
	}
}
...
class Shin extends Thread {
	...
	public void run() {
		...
		System.out.println("1000원 출금 : " + SyncronizationTest.myBank.getMoney());
	}
}
